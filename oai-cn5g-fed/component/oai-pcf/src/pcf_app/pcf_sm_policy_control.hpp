...
class pcf_smpc {
 public:
  ...
  std::string ids_traffic_influence_status_handler();
  std::string ids_traffic_influence_handler(bool active);
 ...
 private:
  ...
  void notify_ids_traffic_influence_change(bool active);
};
}  // namespace oai::pcf::app
