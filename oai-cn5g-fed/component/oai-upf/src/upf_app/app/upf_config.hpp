...
class upf_config {
 public:
  ...
  uint32_t max_upf_interfaces;
  uint32_t max_upf_redirect_interfaces;
  uint32_t max_pdu_session;
  uint32_t max_pdrs_per_pdu_session;
  uint32_t max_sdf_filters_per_pdu_session;
  uint32_t max_arp_entries;
  ...
  upf_config()
      : m_rw_lock(),
        ...
        pdns(),
        smfs(),
        max_upf_interfaces(16),
        max_upf_redirect_interfaces(16),
        max_pdu_session(200000),
        max_pdrs_per_pdu_session(32),
        max_sdf_filters_per_pdu_session(32),
        max_arp_entries(10000),
        max_pfcp_sessions(200000),
        nsf(),
        enable_snat(false),
        nrf_addr() {
