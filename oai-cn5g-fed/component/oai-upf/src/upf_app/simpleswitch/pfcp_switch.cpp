...
pfcp_switch::pfcp_switch()
    : seid_generator_(),
      teid_n3_generator__(),
      ue_ipv4_hbo2pfcp_pdr(upf_cfg.max_pfcp_sessions),
      ul_n3_teid2pfcp_pdr(upf_cfg.max_pfcp_sessions),
      up_seid2pfcp_sessions(upf_cfg.max_pfcp_sessions),
      sock_w(0) {
  Logger::upf_app().info(
      "pfcp_switch: AtomicHashMap capacity = %u (max_pfcp_sessions)",
      upf_cfg.max_pfcp_sessions);
