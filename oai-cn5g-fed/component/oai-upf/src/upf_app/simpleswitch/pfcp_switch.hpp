...
// These defines are unused — pfcp_switch constructor reads upf_cfg.max_pfcp_sessions instead.
#define PFCP_SWITCH_MAX_SESSIONS 200000
#define PFCP_SWITCH_MAX_PDRS 200000
