...
//-----------------------------------------------------------------------------
void pdu_session_create_sm_context_request::set_serving_tac(
    const std::string& tac) {
  m_serving_tac        = tac;
  m_serving_tac_is_set = true;
}

//-----------------------------------------------------------------------------
std::string pdu_session_create_sm_context_request::get_serving_tac() const {
  return m_serving_tac;
}

//-----------------------------------------------------------------------------
bool pdu_session_create_sm_context_request::serving_tac_is_set() const {
  return m_serving_tac_is_set;
}
...
//-----------------------------------------------------------------------------
void pdu_session_update_sm_context_request::set_serving_tac(
    const std::string& tac) {
  m_serving_tac        = tac;
  m_serving_tac_is_set = true;
}
...
//-----------------------------------------------------------------------------
std::string pdu_session_update_sm_context_request::get_serving_tac() const {
  return m_serving_tac;
}

//-----------------------------------------------------------------------------
bool pdu_session_update_sm_context_request::serving_tac_is_set() const {
  return m_serving_tac_is_set;
}
