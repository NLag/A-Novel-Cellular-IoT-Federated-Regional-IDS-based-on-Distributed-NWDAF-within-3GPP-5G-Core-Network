...
class smf_pdu_session : public std::enable_shared_from_this<smf_pdu_session> {
 public:
  ...
  smf_pdu_session(pdu_session_id_t psi)
    ...
    timer_T3592         = ITTI_INVALID_TIMER_ID;
	    ...
	    ids_traffic_duplication_enabled            = false;
	    ids_traffic_duplication_teid               = 0;
	    ids_traffic_duplication_port               = 0;
	  }
 ...
 public:
  ...
  timer_id_t timer_T3592;
	  ...
	  bool ids_traffic_duplication_enabled;
	  std::string ids_traffic_duplication_host;
	  uint32_t ids_traffic_duplication_teid;
	  uint16_t ids_traffic_duplication_port;
	  std::string serving_tac;
