...
class pdu_session_create_sm_context_request
 ...
 public:
  ...
  void set_serving_tac(const std::string& tac);
  std::string get_serving_tac() const;
  bool serving_tac_is_set() const;
 ...
 private:
  ...
  guami_5g_t m_guami;
  std::string m_serving_tac;
  bool m_serving_tac_is_set = false;
};
