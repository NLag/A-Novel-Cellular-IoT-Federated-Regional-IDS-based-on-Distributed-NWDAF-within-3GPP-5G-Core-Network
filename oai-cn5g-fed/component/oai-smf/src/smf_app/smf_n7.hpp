...
class smf_n7 {
 public:
  ...
  void probe_pcf_for_ids_notifications();
  void set_ids_traffic_influence_active(bool active);
  bool ids_traffic_influence_active() const;
 ...
 private:
  ...
  std::atomic_bool m_ids_traffic_influence_active{false};
  std::atomic_bool m_ids_pcf_startup_probe_done{false};
};
}  // namespace smf::n7
