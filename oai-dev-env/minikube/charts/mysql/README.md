...
These helm-charts are from [helm-charts repo](https://github.com/helm/charts/tree/master/stable/mysql). As of Nov 13, 2020, charts repo will no longer be updated. For more information, see the Helm Charts [Deprecation and Archive Notice](https://github.com/helm/charts#%EF%B8%8F-deprecation-and-archive-notice), and [Update](https://helm.sh/blog/charts-repo-deprecation/).
