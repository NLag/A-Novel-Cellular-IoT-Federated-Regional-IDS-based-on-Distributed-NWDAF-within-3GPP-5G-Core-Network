...
-- Dev lab bulk seed for five 100-UE PacketRusher regions.
-- Existing static-IP rows are preserved by INSERT IGNORE.
DELIMITER //
CREATE PROCEDURE seed_oai_dev_ue_range()
BEGIN
  DECLARE i INT DEFAULT 100;
  DECLARE supi_value VARCHAR(15);

  WHILE i <= 599 DO
    SET supi_value = CONCAT('001010000000', LPAD(i, 3, '0'));
    ...
    VALUES
      (supi_value, '5G_AKA', 'fec86ba6eb707ed08905757b1bb44b8f', 'fec86ba6eb707ed08905757b1bb44b8f', '{\"sqn\": \"000000000020\", \"sqnScheme\": \"NON_TIME_BASED\", \"lastIndexes\": {\"ausf\": 0}}', '8000', 'milenage', 'C42449363BBAD02B66D16BC975D77CC1', NULL, NULL, NULL, NULL, supi_value);

    INSERT IGNORE INTO `SessionManagementSubscriptionData`
      (`ueid`, `servingPlmnid`, `singleNssai`, `dnnConfigurations`)
    VALUES
      (supi_value, '00101', '{\"sst\": 1, \"sd\": \"FFFFFF\"}', '{\"oai\":{\"pduSessionTypes\":{\"defaultSessionType\":\"IPV4\"},\"sscModes\":{\"defaultSscMode\":\"SSC_MODE_1\"},\"5gQosProfile\":{\"5qi\":6,\"arp\":{\"priorityLevel\":1,\"preemptCap\":\"NOT_PREEMPT\",\"preemptVuln\":\"NOT_PREEMPTABLE\"},\"priorityLevel\":1},\"sessionAmbr\":{\"uplink\":\"1000Mbps\",\"downlink\":\"1000Mbps\"}}}');
...
CALL seed_oai_dev_ue_range();
DROP PROCEDURE seed_oai_dev_ue_range;
