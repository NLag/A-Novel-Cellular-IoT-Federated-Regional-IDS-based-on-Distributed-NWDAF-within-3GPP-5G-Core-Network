...
- NWDAF Model Training Logical Function [**MTLF**]
- NWDAF Engine [**Engine**]
- NWDAF Southbound Interface [**SBI**]
- Data Collection Coordination Function [**DCCF**]

The repository also includes the NWDAF-owned MTLF and DCCF component trees under `components/oai-nwdaf-mtlf` and `components/oai-nwdaf-dccf`.
